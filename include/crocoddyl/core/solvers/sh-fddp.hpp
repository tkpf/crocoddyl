...
#ifndef CROCODDYL_CORE_SOLVERS_SH_FDDP_HPP_
#define CROCODDYL_CORE_SOLVERS_SH_FDDP_HPP_
 ...
 */
class SolverSHFDDP : public SolverSHDDP {
 public:
...
#endif  // CROCODDYL_CORE_SOLVERS_SH_FDDP_HPP_
