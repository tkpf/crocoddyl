...
#ifndef CROCODDYL_CORE_SOLVERS_SH_DDP_HPP_
#define CROCODDYL_CORE_SOLVERS_SH_DDP_HPP_
 ...
 */
class SolverSHDDP : public SolverAbstract {
 public:
   ...
   */
  explicit SolverSHDDP(boost::shared_ptr<ShootingProblem> problem);
  virtual ~SolverSHDDP();
...
#endif  // CROCODDYL_CORE_SOLVERS_SH_DDP_HPP_
